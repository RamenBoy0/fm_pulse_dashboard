        ...
        <div className="container mx-auto px-6 py-10">
            ...
            <div className="flex justify-center items-center">
                ...
                <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
                    ...
                    <div className="mb-6">
                    <div className="mb-4">
                        <p><b>Take out the guess work</b>. Built upon our repositories, the calculator is capable of estimating total building costs
                    ...
                    <div className="mb-4">
                    <div className="mb-2">
                    <h3 className="text-lg font-semibold">What you can do with our Cost Calculator: </h3>
                    </div>
                    <div className="mb-2">

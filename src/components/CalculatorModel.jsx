...
export default function CalculatorModel() {
  ...
  const handleCalculate = async () => {
    ...
    if (isNaN(parseFloat(gfa)) || parseFloat(gfa) <= 0) {
      alert("Please enter a valid positive number for GFA");
      return;
    }
    ...
    if (Object.keys(getCheckedCosts()).length === 0) {
      alert("Please select at least one trade cost");
      return;
    }
    ...
    <div>
      ...
      <div className="flex items-center justify-center bg-gray-100">
        <div className="mt-6 overflow-y-auto max-h-screen">
          ...
          <h4 className="text-l font-semibold text-gray-700 mb-4">
            This calculator provides an estimated range (min / max ) ($ per sqm)
            for the Total Sum and Trade Cost based on the GFA / Building Type
            and Contract Duration provided
          </h4>
          ...
          <div className="mb-4">
            ...
            >
              ...
              <option value="Building_Type_Amenity Centre">
                Amenity Centre
              </option>
              <option value="Building_Type_Business Park">Business Park</option>
              <option value="Building_Type_Flatted Factories">
                Flatted Factories
              </option>
              <option value="Building_Type_Hawker Centre">Hawker Centre</option>
              <option value="Building_Type_Standard Factories">
                Standard Factories
              </option>
                ...
                <div className="text-xl mt-6 p-4 bg-green-100 text-green-800 rounded-lg">
                  <p>
                    ...
                    <div className="mb-4">
                      ...
                      <p>
                        <i>
                          GFA : {fixedGfa} / Building Type : {fixedBuildingType}{" "}
                  ...
                  <div className="flex flex-wrap gap-4 mt-4">
                    ...
                    <div className="flex-1 min-w-[300px] max-w-[50%] bg-white rounded-lg shadow-md p-4">
                      ...
                      <div className="overflow-y-auto max-h-[400px]">
                        <table className="min-w-full table-auto">
                          ...
                          <tbody>
                            {Object.entries(result.trait_cost).map(
                              ([key, value]) => (
                                <tr key={key}>
                                  <td className="px-4 py-2">{key}</td>
                                  <td className="px-4 py-2">
                                    ${formatValue(value.Lower)}
                                  </td>
                                  <td className="px-4 py-2">
                                    ${formatValue(value.Upper)}
                                  </td>
                                  <td className="px-4 py-2">
                    ...
                    <div className="flex-1 min-w-[300px] max-w-[50%] bg-white rounded-lg shadow-md p-4">
                      <h5 className="text-lg font-bold mb-4">
                        Trade Cost Breakdown (%) (Total Sum based on Mean)
                      </h5>
                      <div className="overflow-y-auto max-h-[400px]">
                        <table className="min-w-full table-auto">
                          <thead>
                          ...
                          <tbody>
                            {Object.entries(result.cost_breakdown).map(
                              ([key, value]) => (
                                <tr key={key}>
                                  <td className="px-4 py-2">{key}</td>
                                  <td className="px-4 py-2">

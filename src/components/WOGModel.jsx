      ...
      <div className="flex items-center justify-center bg-gray-100">
        <div className="mt-6 overflow-y-auto max-h-screen">
          ...
          <h4 className="text-l font-semibold text-gray-700 mb-4">
            ...
            for the Total Cost of a building based on the GFA / Building Type
          ...
          {result && (
            <div className="text-xl mt-6 p-4 bg-green-100 text-green-800 rounded-lg">
              ...
              <p>
                <strong>Lower Bound: </strong> ${formatValue(result.lower)} /
                sqm
              </p>
              <p>
                <strong>Predicted Value: </strong> ${formatValue(result.mean)} /
                sqm
              </p>
              <p>
                <strong>Upper Bound: </strong> ${formatValue(result.upper)} /
                sqm
              </p>
            </div>
          )}
